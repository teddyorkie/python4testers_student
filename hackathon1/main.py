...
class CheckHardSolutions(unittest.TestCase):
    def test_sortlist_last(self):
        self.assertEqual(hard.sort_list_last([(1, 2, 2), (9, 1, 2), (6, 4, 4), (3, 2, 4), (10, 2, 1)]), 
                        [(6, 4, 4), (3, 2, 4), (1, 2, 2), (9, 1, 2), (10, 2, 1)])
        self.assertEqual(hard.sort_list_last([('Tom', 5, 8), ('John', 9, 10), ('Jonny', 8, 10), ('Jason', 10, 10), ('Anna', 3, 8)]), 
