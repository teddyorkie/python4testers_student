...
class Application():
    def __init__(self, master, *args, **kwargs):
        ...
        self.enterid = Label(self.left, text="Enter Product's ID", font=(
            'arial 18 bold'), fg='white', bg='black')
        self.enterid.place(x=0, y=80)

        self.enteride = Entry(self.left, width=25, font=(
        ...
        self.total_l = Label(self.right, text="", font=(
            'arial 40 bold'), bg='lightblue', fg='white')
    ...
    def ajax(self, *args, **kwargs):
        ...
        if self.pc:
            ...
            self.productname.configure(
                text="Product's Name: " + str(self.get_name), fg='white', bg='black')
            self.pprice.configure(
                text="Price:RS. "+str(self.get_price), fg='white', bg='black')
        ...
        # craete the quantity and the discount label
            ...
            self.quantity_e = Entry(self.left, width=25, font=(
                'arial 18 bold'), bg='lightblue')
        ...
        # add to cart button
            self.add_to_cart_btn = Button(
                self.left, text="Add to Cart", width=22, height=2, bg='orange', command=self.add_to_cart)
        ...
        # genrate bill and change
            ...
            self.change_e = Entry(self.left, width=25, font=(
                'arial 18 bold'), bg='lightblue')
        ...
        # geneerate bill button
            self.bill_btn = Button(self.left, text="Generate Bill", width=100,
                                   height=2, bg='red', fg='white', command=self.generate_bill)
        ...
        if self .quantity_value > int(self.get_stock):
            ...
            for self.p in products_list:
                ...
                self.tempprice = Label(self.right, text=str(
                    product_price[self.counter]), font=('arial 18 bold'), bg='gray', fg='white')
                ...
                self.total_l.configure(
                    text="Total : VND "+str(sum(product_price)), bg='gray', fg='white')
                # delete
    ...
    def change_func(self, *args, **kwargs):
        ...
        self.c_amount = Label(self.left, text="Change: Rs. " +
                              str(self.to_give), font=('arial 18 bold'), fg='red', bg='black')
